...
void MillstoneB::OnStartup(Entity* self) {
...
void MillstoneB::SpawnLegs(Entity* self, const std::string& loc) {
...
void MillstoneB::OnChildLoaded(Entity* self, Entity* child) {
...
void MillstoneB::NotifyDie(Entity* self, Entity* other, Entity* killer) {
...
void MillstoneB::OnChildRemoved(Entity* self, Entity* child) {
	auto legTable = self->GetVar<std::vector<LWOOBJID>>(u"legTable");
...
void MillstoneB::OnTimerDone(Entity* self, std::string timerName) {
