...
void SpawnerSpinner85::OnStartup(Entity* self) {
	IsActivated = 0;
...
void SpawnerSpinner85::OnProximityUpdate(Entity* self, Entity* entering, std::string name, std::string status) {
...
void SpawnerSpinner85::SpawnLegs(Entity* self, const std::string& loc) {
...
void SpawnerSpinner85::OnChildLoaded(Entity* self, Entity* child) {
...
void SpawnerSpinner85::NotifyDie(Entity* self, Entity* other, Entity* killer) {
...
void SpawnerSpinner85::OnChildRemoved(Entity* self, Entity* child) {
...
void SpawnerSpinner85::OnTimerDone(Entity* self, std::string timerName) {
...
// Initialize defaults
Entity* SpawnerSpinner85::player1 = nullptr;
Entity* SpawnerSpinner85::player2 = nullptr;
Entity* SpawnerSpinner85::player3 = nullptr;
Entity* SpawnerSpinner85::player4 = nullptr;