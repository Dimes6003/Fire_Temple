...
void Spinner24::OnStartup(Entity* self) {
	...
	self->AddTimer("BladeGUID", 11.2f);
}

void Spinner24::OnSkillEventFired(Entity* self, Entity* caster, const std::string& message) {
...
void Spinner24::TriggerDrill(Entity* self) {
...
void Spinner24::SpawnLegs(Entity* self, const std::string& loc) {
...
void Spinner24::OnChildLoaded(Entity* self, Entity* child) {
...
void Spinner24::NotifyDie(Entity* self, Entity* other, Entity* killer) {
...
void Spinner24::OnChildRemoved(Entity* self, Entity* child) {
	RenderComponent::PlayAnimation(self, u"down");	
...
void Spinner24::OnProximityUpdate(Entity* self, Entity* entering, std::string name, std::string status) {
...
void Spinner24::OnTimerDone(Entity* self, std::string timerName) {
