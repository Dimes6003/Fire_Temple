...
void Spinner26::OnStartup(Entity* self) {
	m_Counter = 1;		
...
void Spinner26::SpawnLegs(Entity* self, const std::string& loc) {
...
void Spinner26::OnChildLoaded(Entity* self, Entity* child) {
...
void Spinner26::NotifyDie(Entity* self, Entity* other, Entity* killer) {
...
void Spinner26::OnChildRemoved(Entity* self, Entity* child) {
	RenderComponent::PlayAnimation(self, u"down");	
...
void Spinner26::OnProximityUpdate(Entity* self, Entity* entering, std::string name, std::string status) {
...
void Spinner26::OnTimerDone(Entity* self, std::string timerName) {
