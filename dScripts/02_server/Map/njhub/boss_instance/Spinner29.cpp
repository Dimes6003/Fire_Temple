...
void Spinner29::OnStartup(Entity* self) {
...
void Spinner29::OnSkillEventFired(Entity* self, Entity* caster, const std::string& message) {
...
void Spinner29::TriggerDrill(Entity* self) {
...
void Spinner29::SpawnLegs(Entity* self, const std::string& loc) {
...
void Spinner29::OnChildLoaded(Entity* self, Entity* child) {
...
void Spinner29::NotifyDie(Entity* self, Entity* other, Entity* killer) {
...
void Spinner29::OnChildRemoved(Entity* self, Entity* child) {
	RenderComponent::PlayAnimation(self, u"down");	
...
void Spinner29::OnProximityUpdate(Entity* self, Entity* entering, std::string name, std::string status) {
...
void Spinner29::OnTimerDone(Entity* self, std::string timerName) {
