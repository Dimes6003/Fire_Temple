...
void Spinner34::OnStartup(Entity* self) {
	m_Counter = 0;		
	forcedown = 1;	
...
void Spinner34::OnChildLoaded(Entity* self, Entity* child) {
...
void Spinner34::NotifyDie(Entity* self, Entity* other, Entity* killer) {
...
void Spinner34::OnChildRemoved(Entity* self, Entity* child) {
	RenderComponent::PlayAnimation(self, u"down");	
...
void Spinner34::OnProximityUpdate(Entity* self, Entity* entering, std::string name, std::string status) {
...
void Spinner34::OnTimerDone(Entity* self, std::string timerName) {
