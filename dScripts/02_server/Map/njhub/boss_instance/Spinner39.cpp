...
void Spinner39::OnStartup(Entity* self) {
	self->SetNetworkVar(u"bIsInUse", false);
	self->SetVar(u"bActive", true);
	self->AddTimer("MoveDown", 20.3f);	
	SpawnLegs(self, "Button3");	
}

void Spinner39::SpawnLegs(Entity* self, const std::string& loc) {
...
void Spinner39::OnChildLoaded(Entity* self, Entity* child) {
...
void Spinner39::NotifyDie(Entity* self, Entity* other, Entity* killer) {
...
void Spinner39::OnChildRemoved(Entity* self, Entity* child) {
	auto legTable = self->GetVar<std::vector<LWOOBJID>>(u"legTable");
...
void Spinner39::OnTimerDone(Entity* self, std::string timerName) {
