...
void Spinner40::OnStartup(Entity* self) {
	self->SetNetworkVar(u"bIsInUse", false);
	self->SetVar(u"bActive", true);
	self->AddTimer("MoveDown", 20.6f);	
	SpawnLegs(self, "Button1");	
}

void Spinner40::SpawnLegs(Entity* self, const std::string& loc) {
...
void Spinner40::OnChildLoaded(Entity* self, Entity* child) {
...
void Spinner40::NotifyDie(Entity* self, Entity* other, Entity* killer) {
...
void Spinner40::OnChildRemoved(Entity* self, Entity* child) {
	auto legTable = self->GetVar<std::vector<LWOOBJID>>(u"legTable");
...
void Spinner40::OnTimerDone(Entity* self, std::string timerName) {
