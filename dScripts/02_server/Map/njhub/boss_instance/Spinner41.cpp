...
void Spinner41::OnStartup(Entity* self) {
	self->SetNetworkVar(u"bIsInUse", false);
	self->SetVar(u"bActive", true);
	self->AddTimer("MoveDown", 20.8f);	
	SpawnLegs(self, "Button2");	
	SpawnLegs(self, "Button3");	
}

void Spinner41::SpawnLegs(Entity* self, const std::string& loc) {
...
void Spinner41::OnChildLoaded(Entity* self, Entity* child) {
...
void Spinner41::NotifyDie(Entity* self, Entity* other, Entity* killer) {
...
void Spinner41::OnChildRemoved(Entity* self, Entity* child) {
	auto legTable = self->GetVar<std::vector<LWOOBJID>>(u"legTable");
...
void Spinner41::OnTimerDone(Entity* self, std::string timerName) {
