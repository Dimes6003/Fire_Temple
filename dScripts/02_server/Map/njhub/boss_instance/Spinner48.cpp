...
void Spinner48::SpawnLegs(Entity* self, const std::string& loc) {
...
void Spinner48::OnChildLoaded(Entity* self, Entity* child) {
...
void Spinner48::NotifyDie(Entity* self, Entity* other, Entity* killer) {
...
void Spinner48::OnChildRemoved(Entity* self, Entity* child) {
	auto legTable = self->GetVar<std::vector<LWOOBJID>>(u"legTable");
...
void Spinner48::OnTimerDone(Entity* self, std::string timerName) {
